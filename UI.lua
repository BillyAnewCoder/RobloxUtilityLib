...
function library:CreateWindow(Keybind, Name)
    ...
    window.name = Name or "Custom UI Library";
    ...
    function window:CreateTab(Name)
        ...
        function tab:CreateSector(Name, Side)
            ...
            function Sector:CreateSlider(Text, Min, Defult, Max, Decimals, Callback, Flag)
                ...
                Slider.OutPutText.Position = UDim2.fromOffset(0,0);
            ...
            function Sector:CreateLabel(Text)
                ...
                Label.MainBack = Instance.new("Frame", Sector.Items);
                Label.MainBack.BackgroundColor3 = library.theme.BackGround;
                Label.MainBack.Size = UDim2.fromOffset(240, 35);
                ...
                Label.TextLabel.Size = UDim2.fromOffset(240, 35);
